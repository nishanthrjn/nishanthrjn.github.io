...
> Software engineer building current hands-on Python backend capability with FastAPI, REST APIs, PostgreSQL, Docker, and AI-enabled services, backed by extensive professional experience in backend systems, databases, integration, debugging, and production support.

### C#/.NET

> Hands-on C#/.NET software engineer experienced in backend and desktop development, SQL-backed workflows, application integration, production support, and legacy modernization.

### Backend

> C#/.NET backend developer experienced in REST integration, SQL-backed workflows, PostgreSQL, SQL Server, containerized delivery, application integration, debugging, and production support.
...
> Software engineer with Web GIS and geodetic-data coursework, an ArcGIS prototype, and professional spatial/geometry-validation experience in CAD systems.
...
> Based in Hannover, authorized to work in Germany under an EU Blue Card, immediately available, and open to relocation.
...
> Softwareentwickler mit mehr als zehn Jahren Berufserfahrung in Backend-Systemen, Desktop-Anwendungen, CAD-integrierter Engineering-Software, SQL-gestützten Workflows, Unternehmensanwendungen, Integration, Modernisierung, Fehleranalyse und Produktionssupport. Der Schwerpunkt meiner kommerziellen Erfahrung liegt in C#/.NET und SQL. Aktuell erweitere ich diese Basis durch strukturierte Weiterbildung und eigene Projekte in Richtung Python und Applied AI mit FastAPI, RAG, LLM-Integration, Vektorsuche und agentischen Systemen.
...
> Praxisorientierter C#/.NET-Softwareentwickler mit Erfahrung in Backend- und Desktop-Entwicklung, SQL-gestützten Workflows, Anwendungsintegration, Produktionssupport und Legacy-Modernisierung.
...
- Smartdale: Senior software engineer with architectural and delivery ownership, leading a small agile team.
...
- Do not imply work authorization outside Germany without verification.
